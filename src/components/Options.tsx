...
export const OptionsContainer = observer(function OptionsContainer({
	isDragging,
}: {
	isDragging: boolean;
}) {
...
export const OptionsPanelWrapper = observer(function OptionsPanelWrapper({
	type,
	optionKey,
	title,
}: OptionType) {
...
export const OptionsPanel = observer(function OptionsPanel({
	type,
	optionKey,
}: Omit<OptionType, "title">) {
	const canvasStore = useCanvasStore();
