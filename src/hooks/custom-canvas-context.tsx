...
export const CustomCanavsContext = createContext<CustomCanvasContext>(
	{} as CustomCanvasContext,
);
type CanvasAction = "click" | "pan" | "zoom" | "none";
export const CustomCanavsContextProvider = observer(
	function CustomCanavsContextProvider({
		children,
	}: {
...
export const useCustomCanvas = (): CustomCanvasContext =>
	useContext(CustomCanavsContext);
