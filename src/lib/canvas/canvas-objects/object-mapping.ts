import { ElementEnum, ICanvasObject, IObjectValue } from "@/types/custom-canvas";

import { Circle } from "./circle";
import { Pencil } from "./pencil";
import { Rectangle } from "./rectangle";

export const CavasObjectMap: { [key in ElementEnum]: (initValues: Partial<IObjectValue>) => ICanvasObject } = {
    ...
    [ElementEnum.Move]: function (): ICanvasObject {
